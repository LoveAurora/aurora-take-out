...
public class OrderTask {
    ...
    public void processTimeoutOrder() {
        ...
        List<Orders> ordersList = ordersService.getByStatusAndOrderTimeLT(Orders.PENDING_PAYMENT, time);
